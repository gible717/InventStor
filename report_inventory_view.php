...
<body>
    ...
    <div class="document-container">
        ...
        <div class="report-header">
            <img src="assets/img/logo.png" alt="Logo" class="report-logo">
            <div class="report-org"><?php echo htmlspecialchars(orgName()); ?></div>
            <div class="report-unit"><?php echo htmlspecialchars(orgUnit()); ?></div>
