 ...
 */
function orgName() {
    return env('ORG_NAME', 'Your Organization Name');
}

/**
 * Get organization unit/department from config
 */
function orgUnit() {
    return env('ORG_UNIT', 'Your Department');
}

/**
 * Get organization short name from config
 */
function orgShortName() {
    return env('ORG_SHORT_NAME', 'ORG');
}
