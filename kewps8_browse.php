        ...
        btn.addEventListener('click', function() {
            ...
            if (stock === 0) {
                Swal.fire({
                    ...
                    html: '<strong>' + name + '</strong> tiada stok pada masa ini.<br><small class="text-muted">Sila hubungi <strong><?php echo htmlspecialchars(orgUnit()); ?></strong> untuk maklumat lanjut.</small>',
